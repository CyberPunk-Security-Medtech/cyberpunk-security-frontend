...
export default function InventoryListClient() {
  ...
  if (loading) return <section className="min-w-0 space-y-8" role="status" aria-label="Loading inventory"><BreadcrumbHeading items={["Inventory"]} description="Loading medicines available for dispensing." /><div className="h-64 animate-pulse rounded border border-[#D8DEE8] bg-gray-100" /></section>;
