...
<button onClick={()=>history.back()} className="mb-4 text-sm w-180 h-45 bg-[#ECEEFD] font-medium rounded-full text-brand-navy hover:underline">← Back to Patients List</button>
